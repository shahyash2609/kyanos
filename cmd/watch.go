...
func init() {
	...
	watchCmd.PersistentFlags().StringVar(&options.WatchOptions.JsonOutputDir, "json-output-dir", "", "Per-pod JSONL output directory; writes <dir>/<pod_name>.jsonl for each observed pod")
